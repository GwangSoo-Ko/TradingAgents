...
def get_ticker() -> str:
    ...
    """
    from tradingagents.dataflows.ticker_resolver import looks_like_ticker, resolve_query
    ...
    manual = questionary.text(
        "Enter the exact ticker symbol (e.g. AAPL, 000660.KS, 0700.HK, GC=F):",
        validate=lambda x: (
...
def _llm_provider_table() -> list[tuple[str, str, str | None]]:
    ...
    return [
        ...
        ("Vertex Model Garden — Claude (claude-opus-5)", "vertex_anthropic", None),
